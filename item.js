    ...
    constructor(type, location)
    {
        ...
        switch(type)
        {
            ...
            case "croissant":
                ...
                this.name = "Crossant";
                this.character = 'o';
                this.description = 'A hearty baked croissant.';
                this.healthEffect = 4;
                this.staminaEffect = 0;
                break;
            ...
            case "wonderbread":
                ...
                this.character = 'd';
                this.description = 'Sugary!';
                this.healthEffect = 0;
                this.staminaEffect = 4;
                break;

            case "sparklingmuffin":
                this.class = "food";
                this.name = "Sparkling Muffin";
                this.character = 'n';
                this.description = 'It glows eerily.';
                this.healthEffect = 4;
                this.staminaEffect = 0;
                this.specialEffect = "exp";
                break;
